@echo off
REM An attempt at a build file for Windows Executable
REM Yes, yes, I know
REM Doesn't compile the electron wrapper
REM requires the same dependencies as the lunix build:
REM   jre
REM   sass
REM   closure -> web/closure/compiler.jar
REM   FactomProject's staticfiles

SETLOCAL
set wallDir=%GOPATH%/src/github.com/FactomProject/enterprise-wallet

call win-build-ui.bat
